...
def main():
    ...
    df.to_json('./시도별코로나현황_%d_%d.json' % (startCreateDt, endCreateDt))
    print('./시도별코로나현황_%d_%d.json SAVED' % (startCreateDt, endCreateDt))
    ...
    print(df)
    df.to_csv('./시도별코로나현황_%d_%d.csv' % (startCreateDt, endCreateDt), encoding='utf-8-sig')
    print('./시도별코로나현황_%d_%d.csv SAVED' % (startCreateDt, endCreateDt))
