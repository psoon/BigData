...
def getTourismStatsItem(yyyymm, national_code, ed_cd):
    ...
    parameters = "InfStateJson?serviceKey=" + ServiceKey   #인증키
    parameters += "&startCreateDt=" + yyyymm
...
def main():
    ...
    result = []
    natName=''
    nStartYear =int(input('데이터를 몇 년부터 수집할까요? : ex)20200310'))
    nEndYear = int(input('데이터를 몇 년까지 수집할까요?(20220310) : '))
